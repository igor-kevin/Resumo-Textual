...
A IA tem muitos benefícios potenciais para a humanidade, como aumentar a produtividade, melhorar a saúde, reduzir a pobreza, combater as mudanças climáticas, ampliar a educação, entreter e inspirar as pessoas, etc. No entanto, a IA também tem muitos riscos e desafios, como causar desemprego, violar a privacidade, gerar vieses, criar conflitos, diminuir a autonomia, ameaçar a segurança, etc. Por isso, é importante que a IA seja desenvolvida e usada de forma responsável, ética e humana, respeitando os valores, os direitos e as necessidades das pessoas e da sociedade. É DE'''
if texto.count('.') > 3:
...
frases_ordem = sorted(pontuacao_frase, key=pontuacao_frase.get, reverse=True)
# print(frases_ordem)
